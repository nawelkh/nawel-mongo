...
export class Editformprof extends Component {
    state = {
        step :1 ,
        nom:'',
        prenom:'',
    ...
    render() { 
        ...
        switch (step) {
            ...
            return (
             ...
             case 4 :
                return( 
                   <Paper style={{ width: 300,height: 250, paddingLeft: 50, marginLeft: '35%' , marginTop: 50}}>
                  <Grid  onSubmit={this.handlesubmitform} nextStep = {this.nextStep }>
                   <List style={{top:20 }}>
                   ...
                   <br/>
                   <Button style={{top: 30 , left: 60}} variant="contained" color="primary" onClick={this.continue}>Ok</Button> 
                   </Grid> </Paper>
                );  
